...
exports.init = function(req, res) {
  res.render("account/contact/myaccount", {
...
exports.find = function(req, res, next){
  ...
  req.app.db.models.User.pagedFind({
    ...
    if (req.xhr) {
      ...
      results.filters = req.query;
      res.render('account/contact/index', { data: { results: JSON.stringify(results) } });
    }
  });
};
...
exports.myIndex = function(req, res) {
  res.render("account/contact/myIndex", {
    user: 1234
  });
};


exports.exps = function(req, res) {
