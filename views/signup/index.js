...
exports.signup = function(req, res){
  ...
  workflow.on('validate', function() {
    ...
    var goodpass1 = true, goodpass2 = true;
    ...
    if (!req.body.password2) {
      goodpass2 = false;
      workflow.outcome.errfor.password2 = 'required';
    }

    if (goodpass1 && goodpass2) {
      if(req.body.password !== req.body.password2) {
        workflow.outcome.errfor.password = "not equal";
        workflow.outcome.errfor.password2 = "not equal";
      }
    }
