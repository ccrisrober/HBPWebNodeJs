  ...
  grunt.initConfig({
    ...
    copy: {
      vendor: {
        files: [
          {
//para que funcione tiene que ser app/bowe...
          ...
          {
            expand: true, cwd: 'app/bower_components/highcharts/',
            src: ['highcharts.js'], dest: 'public/vendor/highcharts/'
          },
          {
            expand: true, cwd: 'app/bower_components/bootstrap-filestyle/src/',
            src: ['bootstrap-filestyle.js'], dest: 'public/vendor/bootstrap-filestyle/'
          },
          {
            expand: true, cwd: "bower_components/slimScroll/",
            src: ["**"], dest: "public/vendor/slimScroll/" 
          },
          {
            expand: true, cwd: "bower_components/datatables/",
            src: ["**"], dest: "public/vendor/datatables/" 
          }
        ]
      }
    },
    ...
    watch: {
      clientJS: {
         files: [
          ...
          'public/vendor/highcharts/*.js', '!public/vendor/highcharts/*js'
         ],
